...
class Settings(BaseSettings):
    ...
    # LLM provider selection — "gemini" (default) or "anthropic". The
    # provider abstraction lives in app.services.llm.
    llm_provider: str = "gemini"
    # Default model id passed to the active provider. Defaults match
    # the active provider's flagship at time of writing; override per
    # provider if needed.
    ...
    # users (e.g. Sarah's current override is 2M).
    ...
    smtp_from_name: str = "Atlas Alerts"
    ...
    # Defaults aim for richer, less-thin output on Atlas's voice clone

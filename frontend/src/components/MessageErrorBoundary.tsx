    ...
    if (this.state.hasError) {
      return (
        <div className="flex justify-start">
          <div className="max-w-[85%] rounded border border-brand-red-600/40 bg-brand-red-600/5 px-4 py-2 text-xs italic text-brand-red-600 dark:border-brand-red-400/40 dark:text-brand-red-400">
